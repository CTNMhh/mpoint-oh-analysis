...
export default function AdminNewsEditPage() {
  ...
  // Optimierter Fetch mit AbortController für schnelleres Laden
  useEffect(() => {
  ...
  const saveDraft = useCallback(() => {
    localStorage.setItem(`news-draft-${id}`, JSON.stringify(form));
    setSuccess("Entwurf automatisch gespeichert");
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600 font-medium">Lade News-Artikel...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">News bearbeiten</h1>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="lg:col-span-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Kurze Zusammenfassung für Übersichten"
                    required
                    maxLength={200}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
                  />
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  value={form.longText}
                  onChange={handleChange}
                  placeholder="Vollständiger Artikel-Text (HTML-Formatierung möglich)"
                  required
                  rows={12}
